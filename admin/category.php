...
<label class="control-label" for="basicinput">Nom de catégorie</label>
<div class="controls">
<input type="text" placeholder="Entrez le nom de la catégorie"  name="category" class="span8 tip" required>
</div>
</div>
...
?>									
										<tr>
											...
											<td>
											<a href="edit-category.php?uname=<?php echo $uname; ?>&id=<?php echo $row['id']?>" ><i class="icon-edit"></i></a>
											<a href="category.php?uname=<?php echo $uname; ?>&id=<?php echo $row['id']?>&del=delete" onClick="return confirm('\n'+'Etes-vous sûr que vous voulez supprimer?')"><i class="icon-remove-sign"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; } ?>
